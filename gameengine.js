...
Entity.prototype.draw = function (ctx) {
	...
	this.game.ctx.strokeText(this.game.entities[0].name, 18, 70);
	this.game.ctx.fillStyle="#FFFFFF";
	this.game.ctx.fillText(this.game.entities[0].name, 18, 70);
	this.game.ctx.strokeStyle="#FF0000";
	this.game.ctx.strokeText(this.game.entities[1].name, 910, 70);
	this.game.ctx.fillText(this.game.entities[1].name, 910, 70);
